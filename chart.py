...
def show_income(user_id):
    ...
    plt.pie(money,explode=None,labels=type_list,colors=color,labeldistance=1.1,autopct = "%1.2f%%",shadow=True,startangle=90,pctdistance=0.6,textprops = {"fontsize" : 12})
    plt.axis('equal') 
